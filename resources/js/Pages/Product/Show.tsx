import {Product, VariationTypeOptions} from "@/types";
...
function Show({product, variationOptions}: { product: Product, variationOptions: number[] }) {
  ...
  const [selectedOptions, setSelectedOptions] = useState<Record<number, VariationTypeOptions>>([]);
  ...
  useEffect(() => {
    const idsMap = Object.fromEntries(
      Object.entries(selectedOptions).map(([typeId, option]: [string, VariationTypeOptions]) => [typeId, option.id])
    );
    console.log(idsMap);
